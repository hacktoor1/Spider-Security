...
### PHP Blind Path Traversal <a href="#php-blind-path-traversal" id="php-blind-path-traversal"></a>
...
[PAGELFI2RCE via phpinfo()](https://book.hacktricks.xyz/pentesting-web/file-inclusion/lfi2rce-via-phpinfo)
