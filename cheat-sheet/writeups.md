...
* [Bypass Uppercase filters like a PRO(XSS advanced methods)](https://medium.com/@Master\_SEC/bypass-uppercase-filters-like-a-pro-xss-advanced-methods-daf7a82673ce)
...
* [Cookie based XSS exolpoitation 2300 bug bounty](https://medium.com/@iSecMax/%D1%81ookie-based-xss-exploitation-2300-bug-bounty-story-9bc532ffa564)
...
* [Stored XSS on techprofile Microsoft](https://medium.com/@kang\_ali/stored-xss-on-techprofile-microsoft-d21757588cc1)
...
* [Admob Creative image XSS](https://bitquark.co.uk/blog/2013/07/19/admob\_creative\_image\_xss)
* [Amazon Packaging feedback XSS](https://bitquark.co.uk/blog/2013/07/03/amazon\_packaging\_feedback\_xss)
...
* [How I found a 5000 Google maps XSS by fiddling with protobuf](https://medium.com/@marin\_m/how-i-found-a-5-000-google-maps-xss-by-fiddling-with-protobuf-963ee0d9caff)
...
* [How I found Blind XSS vulnerability in redacted.com](https://medium.com/@newp\_th/how-i-find-blind-xss-vulnerability-in-redacted-com-33af18b56869)
...
* [XSS through SWF file](https://medium.com/@friendly\_/xss-through-swf-file-4f04af7b0f59)
...
* [Reflected XSS on amazon](https://medium.com/@newp\_th/reflected-xss-on-ws-na-amazon-adsystem-com-amazon-f1e55f1d24cf)
...
* [XSS at hubspot and in email areas](https://medium.com/@friendly\_/xss-at-hubspot-and-xss-in-email-areas-674fa39d5248)
* [Self XSS leads to blind XSS and Reflected XSS](https://medium.com/@friendly\_/self-xss-leads-to-blind-xss-and-reflected-xss-950b1dc24647)
* [Refltected XSS primagames.com](https://medium.com/@friendly\_/reflected-xss-primagames-com-c7a641912626)
* [Stored XSS in gameskinny](https://medium.com/@friendly\_/stored-xss-in-gameskinny-aa26c6a6ae40)
...
* [XSS Vulnerability in Netflix](https://medium.com/@black\_b/vulnerability-netflix-cross-site-scripting-xss-d44010142e2c)
...
* [XSS in microsoft](https://medium.com/@hacker\_eth/xss-in-microsoft-7a70416aee75)
* [Blind XSS at customer support panel](https://blog.hx01.me/2018/05/blind-xss-to-customer-support-panel.html)
* [Reflected XSS on stackoverflow](https://medium.com/@newp\_th/reflected-xss-on-stack-overflow-b8366a855472)
...
* [How I got stored XSS using file upload](https://medium.com/@vis\_hacker/how-i-got-stored-xss-using-file-upload-5c33e19df51e)
...
* [XSS via angularjs template injection hostinger](https://blog.ibrahimdraidia.com/xss-via-angularjs-template-injection\_hostinger/)
...
* [CSRF Bypass using cross frame scripting](https://medium.com/@mr\_hacker/csrf-bypass-using-cross-frame-scripting-c349d6f33eb6)
...
* [Clickjacking in google docs and void typing feature](https://medium.com/@raushanraj\_65039/clickjacking-in-google-docs-and-voice-typing-feature-c481d00b020a)
...
* [Yet another Google Clickjacking](https://medium.com/@raushanraj\_65039/google-clickjacking-6a04132b918a)
...
* [RFI LFI Writeup](http://hassankhanyusufzai.com/RFI\_LFI\_writeup/)
...
* [Bugbounty journey from LFI to RCE](https://medium.com/@logicbomb\_1/bugbounty-journey-from-lfi-to-rce-how-a69afe5a0899)
...
* [Bypassing Host Header to SQL injection to dumping Database — An unusual case of SQL injection](https://medium.com/@logicbomb\_1/bugbounty-database-hacked-of-indias-popular-sports-company-bypassing-host-header-to-sql-7b9af997c610)
...
* [Tesla Motors blind SQLI](https://bitquark.co.uk/blog/2014/02/23/tesla\_motors\_blind\_sql\_injection)
...
* [SSRF port issue hidden approch](https://medium.com/@w\_hat\_boy/server-side-request-forgery-ssrf-port-issue-hidden-approch-f4e67bd8cc86)
* [The jorney of web cache firewall bypass to SSRF to AWS credentials compromise](https://medium.com/@logicbomb\_1/the-journey-of-web-cache-firewall-bypass-to-ssrf-to-aws-credentials-compromise-b250fb40af82)
...
* [Vimeo SSRF with code execution potential](https://medium.com/@rootxharsh\_90844/vimeo-ssrf-with-code-execution-potential-68c774ba7c1e)
...
* [Buffer Overflow Attack Book pdf](http://www.cis.syr.edu/\~wedu/seed/Book/book\_sample\_buffer.pdf)
...
A curated list of bugbounty writeups (Bug type wise) , inspired from [https://github.com/ngalongc/bug-bounty-reference](https://github.com/ngalongc/bug-bounty-reference)

#### Topics

[bugbounty](https://github.com/topics/bugbounty) [bughunting](https://github.com/topics/bughunting) [bugbountytips](https://github.com/topics/bugbountytips) [bugbounty-writeups](https://github.com/topics/bugbounty-writeups) [security-writeups](https://github.com/topics/security-writeups) [bugbounty-blogs](https://github.com/topics/bugbounty-blogs) [bugbounty-yahoo](https://github.com/topics/bugbounty-yahoo) [bugbounty-facebook](https://github.com/topics/bugbounty-facebook) [bughunting-methodology](https://github.com/topics/bughunting-methodology) [bughunting-writeups](https://github.com/topics/bughunting-writeups)

#### Resources

[ Readme](https://github.com/devanshbatham/Awesome-Bugbounty-Writeups#readme-ov-file)[ Activity](https://github.com/devanshbatham/Awesome-Bugbounty-Writeups/activity)

#### Stars

[ **4.5k** stars](https://github.com/devanshbatham/Awesome-Bugbounty-Writeups/stargazers)

#### Watchers

[ **242** watching](https://github.com/devanshbatham/Awesome-Bugbounty-Writeups/watchers)

#### Forks

[ **984** forks](https://github.com/devanshbatham/Awesome-Bugbounty-Writeups/forks)[Report repository](https://github.com/contact/report-content?content\_url=https%3A%2F%2Fgithub.com%2Fdevanshbatham%2FAwesome-Bugbounty-Writeups\&report=devanshbatham+%28user%29)

### [Releases](https://github.com/devanshbatham/Awesome-Bugbounty-Writeups/releases)

No releases published

### [Packages](https://github.com/users/devanshbatham/packages?repo\_name=Awesome-Bugbounty-Writeups)

No packages published\


### [Contributors8](https://github.com/devanshbatham/Awesome-Bugbounty-Writeups/graphs/contributors)

* [![@devanshbatham](https://avatars.githubusercontent.com/u/28016517?s=64\&v=4)](https://github.com/devanshbatham)
* [![@e13v3n-0xb](https://avatars.githubusercontent.com/u/36234942?s=64\&v=4)](https://github.com/e13v3n-0xb)
* [![@0xflotus](https://avatars.githubusercontent.com/u/26602940?s=64\&v=4)](https://github.com/0xflotus)
* [![@TheBinitGhimire](https://avatars.githubusercontent.com/u/20013689?s=64\&v=4)](https://github.com/TheBinitGhimire)
* [![@ChillerDragon](https://avatars.githubusercontent.com/u/20344300?s=64\&v=4)](https://github.com/ChillerDragon)
* [![@SourangshuGhosh](https://avatars.githubusercontent.com/u/39379224?s=64\&v=4)](https://github.com/SourangshuGhosh)
* [![@mohitkhemchandani](https://avatars.githubusercontent.com/u/42883046?s=64\&v=4)](https://github.com/mohitkhemchandani)
* [![@Prabesh01](https://avatars.githubusercontent.com/u/51240439?s=64\&v=4)](https://github.com/Prabesh01)

### Languages

* [Python100.0%](https://github.com/devanshbatham/Awesome-Bugbounty-Writeups/search?l=python)
...
Type / to search![](https://avatars.githubusercontent.com/u/98988408?v=4)

* [Code](https://github.com/devanshbatham/Awesome-Bugbounty-Writeups)
* [Issues8](https://github.com/devanshbatham/Awesome-Bugbounty-Writeups/issues)
* [Pull requests2](https://github.com/devanshbatham/Awesome-Bugbounty-Writeups/pulls)
* [Actions](https://github.com/devanshbatham/Awesome-Bugbounty-Writeups/actions)
* [Projects](https://github.com/devanshbatham/Awesome-Bugbounty-Writeups/projects)
* [Security](https://github.com/devanshbatham/Awesome-Bugbounty-Writeups/security)
* [Insights](https://github.com/devanshbatham/Awesome-Bugbounty-Writeups/pulse)

![Owner avatar](https://avatars.githubusercontent.com/u/28016517?s=48\&v=4)[**Awesome-Bugbounty-Writeups**](https://github.com/devanshbatham/Awesome-Bugbounty-Writeups)Public

* Watch242
* [Fork 984](https://github.com/devanshbatham/Awesome-Bugbounty-Writeups/fork)
* &#x20;Star 4.5k
...
* [Buffer Overflow Attack Book pdf](http://www.cis.syr.edu/\~wedu/seed/Book/book\_sample\_buffer.pdf)
* [Github Repository on Buffer Overflow Attack](https://github.com/npapernot/buffer-overflow-attack)
* [Stack-Based Buffer erflow Attacks: Explained and Examples](https://blog.rapid7.com/2019/02/19/stack-based-buffer-overflow-attacks-what-you-need-to-know/)
* [How Buffer Overflow Attacks Work](https://www.netsparker.com/blog/web-security/buffer-overflow-attacks/)
* [Binary Exploitation: Buffer Overflows](https://blog.usejournal.com/binary-exploitation-buffer-overflows-a9dc63e8b546)
* [WHAT IS A BUFFER OVERFLOW? LEARN ABOUT BUFFER OVERRUN VULNERABILITIES, EX](https://www.veracode.com/security/buffer-overflow)
